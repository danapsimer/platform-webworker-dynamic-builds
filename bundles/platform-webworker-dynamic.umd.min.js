...
/**
     ...
     */var i=new r.Version("7.0.4+13.sha-5e82f8a"),m=r.createPlatformFactory(n.ɵplatformCoreDynamic,"workerAppDynamic",[{provide:r.COMPILER_OPTIONS,useValue:{providers:[{provide:a.ResourceLoader,useClass:n.ɵResourceLoaderImpl,deps:[]}]},multi:!0},{provide:r.PLATFORM_ID,useValue:o.ɵPLATFORM_WORKER_UI_ID}]);
/**
     * @license
     * Copyright Google Inc. All Rights Reserved.
     *
